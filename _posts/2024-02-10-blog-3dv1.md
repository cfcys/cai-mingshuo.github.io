...
> 推导主要参考[Volume Rendering Digest (for NeRF)](https://www.bilibili.com/video/BV1Wd4y1X7H1/?spm_id_from=333.999.0.0&vd_source=32f9de072b771f1cd307ca15ecf84087),个人感觉讲的是真心不错，因此这里算是重复人家的内容，外加推导一些公式来提升下自己的数学功底。。

## 透射率

首先，透射率函数$$指的是光线在区间$$上传播而没有击中任何粒子的概率，我们这里推导$$与密度场$$的关系，
 -->
...
关于相机成像的更详细的内容可以看[这一篇blog](2024-02-10-blog-3dv3.md)
...
![NeRF输入的示意图](image-11.png)

至此，这也与NeRF论文中输入的示意图完美地呼应了起来。

## 网络的输入

根据NeRF原本论文中提供的网络框图，我们发现其网络的输入竟然是达到了60维度，但是我们之前得到的坐标原点+方位角也不过是3+3=6维度
